import { NgModule, Component, ElementRef, Input, ViewContainerRef, ViewChild, Output, EventEmitter, ContentChild, ContentChildren, Renderer2, ChangeDetectorRef, Inject, forwardRef } from '@angular/core';
...
ColumnHeaders.propDecorators = {
    'columns': [{ type: Input, args: ["pColumnHeaders",] },],
};
...
ColumnFooters.propDecorators = {
    'columns': [{ type: Input, args: ["pColumnFooters",] },],
};
...
DataTable.propDecorators = {
    ...
    'headerCheckboxToggleAllPages': [{ type: Input },],
    ...
    'expandableRowGroups': [{ type: Input },],
    'rowExpandMode': [{ type: Input },],
    'expandedRowsGroups': [{ type: Input },],
    'tabindex': [{ type: Input },],
    'rowStyleClass': [{ type: Input },],
    'rowGroupMode': [{ type: Input },],
    'sortableRowGroup': [{ type: Input },],
    'sortFile': [{ type: Input },],
    'rowHover': [{ type: Input },],
    'first': [{ type: Input },],
    'filters': [{ type: Input },],
    ...
    'onRowGroupExpand': [{ type: Output },],
    'onRowGroupCollapse': [{ type: Output },],
